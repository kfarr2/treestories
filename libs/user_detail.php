...
<div id="list-container" class="container">
    ...
    <div id="user_info">
        ...
        <div class="btn-group" id="btn-group" role="group">
            <form class="btn-group" method="POST" action="/cs/libs/user_update.php">
		...
		<input type="hidden" name="user_id" value="<?php echo $result['user_id']; ?>"/>
            ...
            <a href="/cs/admin.php" class="btn btn-warning">Back</a>
            <?php
            if($result['user_id'] != $_SESSION['treestories_user_id']) {
                echo '<form class="btn-group" method="POST" action="/cs/libs/user_delete.php">';
